...
/*
------------
ne pas oublier dans le gradle app :
...
public class VideoActivity extends Activity implements MediaCaptureCallback
{
    ...
    private static final boolean TEST_SEPARATED_CONTROL = true; // etait  false  permet de ne pas enregistrer
    ...
    //private MulticastLock multicastLock = null; //multicastLocksuppress
    ...
    public static VideoActivity sVideoActivity;
    ...
    public int OnCaptureReceiveData(ByteBuffer buffer, int type, int size,
		...
		runOnUiThread(new Runnable()
        {
           @Override
           public void run(){
			   Toast.makeText(VideoActivity.sVideoActivity, "Stop Transcoding", Toast.LENGTH_LONG).show();
			   if(capturer != null)
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        //mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "veg.mediacapture.sdk.test.mediastream");
        //-----------------------------------------------------------------


        //WifiManager wifi = (WifiManager) getSystemService(Context.WIFI_SERVICE);  correction proposée
        //WifiManager wifi = (WifiManager) getApplicationContext().getSystemService(Context.WIFI_SERVICE);//multicastLocksuppress

        //multicastLock = wifi.createMulticastLock("multicastLock"); //multicastLocksuppress
        //multicastLock.setReferenceCounted(true); //multicastLocksuppress
        //multicastLock.acquire(); //multicastLocksuppress
        ...
        //-----------------------------------------------------------------
        //capturer = (MediaCapture)findViewById(R.id.captureView);  // modif rtsp serv
        ...
        mbuttonSettings.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent;
                        if(isRec()){
                            Toast.makeText(VideoActivity.sVideoActivity,"Press 'Stop Streaming' button  first", Toast.LENGTH_LONG).show();
                        }else{
                            // Starts QualityListActivity where user can change the streaming quality
                            intent = new Intent(VideoActivity.sVideoActivity.getBaseContext(),SettingsActivity.class);
    ...
    protected void onDestroy()
    {
        ...
        //if (multicastLock != null) { //multicastLocksuppress
        //   multicastLock.release(); //multicastLocksuppress
        //    multicastLock = null; //multicastLocksuppress
        //} //multicastLocksuppress
        super.onDestroy();
    }
